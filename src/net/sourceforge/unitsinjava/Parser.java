//=========================================================================
//
//  This file was generated by Mouse 1.1 at 2009-11-05 19:54:25 GMT
//  from grammar 'grammar.peg'.
//
//=========================================================================
...
public class Parser extends net.sourceforge.unitsinjava.ParserBase
{
  ...
  boolean unitexpr()
    {
      begin("unitexpr");
      if (unitexpr_0()) {sem.unitexpr(); return accept();} else {
		sem.error();
	}
      return reject();
    }
